...
export default function GamesClient({ physicalGames }) {
    ...
    const [zoomedImage, setZoomedImage] = useState(null); // <--- TAMBAHKAN INI

    const closeModal = () => setSelectedGame(null);

    return (
        <div>
            {/* === SECTION 1: Digital Web Games === */}
                ...
                <div className="container">
                    ...
                    <div className="grid">
                        {digitalGames.map((game, i) => {
                            ...
                            return (
                                <div className={`card animate-in delay-${(i % 3) + 1}`} key={game.id}>
                                    <div className="game-thumbnail">
                                        <Icon size={48} weight="duotone" />
                                    </div>
                                    <div className="game-type">
                                        <span className="badge badge-coral">{game.type}</span>
                                    </div>
                                    <h3>{game.name}</h3>
            ...
            {selectedGame && (
                <div className="modal-overlay" onClick={closeModal}>
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        {/* --- BAGIAN BARU: Menampilkan Gambar jika Thumbnail_URL ada --- */}
